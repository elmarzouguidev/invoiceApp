<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro">
            Editer les informations général du client
        </div>
    </div>
    <div class="col-12 col-md-8">
        <div class="app-card app-card-settings shadow-sm p-4">
            <div class="app-card-body">
                <form class="settings-form" accept="{{route('admin:customers.update',$customer->uuid)}}" method="post">
                    @honeypot
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="name" class="form-label">Raison sociale<span class="ms-2" data-container="body"
                        ...
                        <input type="text" name="name" class="form-control @error('name')  is-invalid @enderror"
                            id="name" value="{{ $customer->name ?? old('name') }}" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="contact"
                            ...
                            value="{{ $customer->contact ?? old('contact') }}" required>
                        @error('contact')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control  @error('email')  is-invalid @enderror"
                            id="email" value="{{ $customer->email ?? old('email') }}">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="address" name="address" rows="5" class="form-control  @error('address')  is-invalid @enderror">{{ $customer->address ?? old('address') }}</textarea>
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="rc" class="form-control  @error('rc')  is-invalid @enderror"
                            id="rc" value="{{ $customer->rc ?? old('rc') }}">
                        @error('rc')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ice" class="form-control  @error('ice')  is-invalid @enderror"
                            id="ice" value="{{ $customer->ice ??  old('ice') }}">
                        @error('ice')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
